namespace kuangRobot {
    ...
    export function RemoteControlRobot(input: string, in_angle: number, low: number, high: number): number {
        ...
        pins.analogWritePin(AnalogPin.P13, R_pwm_bwd)
        pins.analogWritePin(AnalogPin.P12, R_pwm_fwd)
        pins.analogWritePin(AnalogPin.P15, L_pwm_bwd)
        pins.analogWritePin(AnalogPin.P14, L_pwm_fwd)
